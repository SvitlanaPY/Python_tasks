...
for i in arr:         # і - це значення списку "аrr", та індекс для списку "count"
    index_elem = i + 100
    # індекс елемента зміщується на 100: елемент зі значенням '-100' буде мати індекс нуль: -100+х=0
    # (х=100, х - це зміщення)
    # print(index_elem)
    count[index_elem] += 1
print(count)
