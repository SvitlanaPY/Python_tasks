...
# программе делать не нужно, просто обращаетесь к переменной data.
...
lst = []
for dict_ in data['my_friends']['items']:
    lst.append(dict_['first_name'])
# lst: ['Kurt', 'Виолетта', 'Иринка', 'Данил', 'Валентин', 'Евгений', 'Ангелина', 'Иван', 'Паша', 'Ольга']
