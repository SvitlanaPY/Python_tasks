...
brand, model, price и также атрибут laptop_name - строковое значение, вида "<brand> <model>"
...
print(laptop1.laptop_name, laptop1.price)
# Asus 18-bdfx 37000
laptop2 = Laptop('Samsung', '13-bsdf0xx', 47000)
print(laptop2.laptop_name, laptop2.price)
# Samsung 13-bsdf0xx 47000
