...
__str__ буде відповідати за те, як наш об"єкт буде відображатись, якщо до нього застосувати такі ф-ії як str() чи print

__repr__ - для серіалізації та відладки, є виводом, який є читабельним для інтерпретатора Python.
...
__str__ - використовується для створення виводу, який має бути читабельним для кінцевого користувача,
це по суті є print()
# >>> str('hello world')
'hello world'
