"""
AGGREGATION/АГРЕГАЦІЯ - тип композиції, не передбачає права власності на об"єкт.

Об"єкт класу(class Engine) створюємо за межами класу і передаємо його як атрибут в інший клас (class Car):
engine1 = Engine()
car1 = Car(engine1)

Клас Car, який буде приймати об"єкт іншого класу, повинен мати атрибут (self.engine),
щоб прийняти об"єкт від іншого класу(class Engine).
"""
