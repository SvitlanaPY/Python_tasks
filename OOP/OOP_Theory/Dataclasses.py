...
Це такий контейнер, де зберігаємо дані, така собі БД.
...
print(artcl1.page)
На відміну від словників, DataClass дозволяють визначити тип даних, хоча він не є обовязковим і помилка не видається, коли дані будуть іншого типу.
