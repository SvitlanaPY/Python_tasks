...
""" 
доступ до захищених атрибутів класу ззовні (outdoor access) зберігся і 
захищені/protected змінні не вирішують проблеми захисту даних.
...
# Це на рівні узгодження між розробниками
"""
