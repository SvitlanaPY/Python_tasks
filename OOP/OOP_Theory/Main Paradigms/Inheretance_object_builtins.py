...
# ЯКІ АТРИБУТИ і ФУНКЦІЄ МАЄ ОБ"ЄКТ КЛАСУ
pprint.pprint(dir(a))
...
а, отже, наш створений клас вже буде мати певну поведінку, яка унаслідується від класу object, 
які атрибути і ф-ії буде мати наш клас, можна глянути за допомогою ф-ії dir():
dir(Person)
['__class__',
 '__delattr__',
 '__dict__',
