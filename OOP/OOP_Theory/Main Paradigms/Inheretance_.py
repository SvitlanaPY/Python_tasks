...
INHERETANCE/ НАСЛІДУВАННЯ - підхід/механізм/принцип за яким об"єк/клас(підклас/дочірній клас) набуває деяких/чи усіх атрибутів та методів від іншого(батьківського) класу.
