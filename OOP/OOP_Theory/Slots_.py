...
# але тепер вже немає магічної змінної p2.__dict__
...
"""
s = Point(4, 5)   # всі атрибути цього класу Point зберіг-ся в магічній змінній __dict__, і цей словник атрибутів теж займає місце в памяті
