...
class Money:
    ...
    @dollars.setter
    def dollars(self, dollars_):
        if isinstance(dollars_, int) and dollars_ >= 0:
            self.total_cents = dollars_ * 100 + (self.total_cents % 100)
        else:
            print("Error dollars")
    ...
    @cents.setter
    def cents(self, cents_):
        if isinstance(cents_, int) and 0 < cents_ < 100:
            self.total_cents = cents_ + (self.total_cents // 100) * 100
        else:
            print("Error cents")
