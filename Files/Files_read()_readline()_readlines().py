...
# метод readline() - зчитує по рядкуі повертає строкове представлення зчитаного рядка;
fff = open('333.txt')
q = fff.readline()
print("q: ", q)
print("зчитаний ОДИН рядок - q: ", repr(q))
# метод строки rstrip() видаляє справа всі пробільні символи і символи переносу строки4 повернеться строка
