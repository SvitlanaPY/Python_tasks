"""
Сортировки пузырьком (лінійний алгоритм).
...
# оскільки при кожному проході вспливатиме найбільший елемент, то нам вже не потрібно буде порівнювати з останніми елементами
