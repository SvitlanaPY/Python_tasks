...
"""
Коли Пайтон зустрічає виключення, то запускається механізм запуску виключень, 
який перевіряє, чи відбулось виключення в блоці try...except
