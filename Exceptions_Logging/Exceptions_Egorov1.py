...
1. при виконанні коду (виключення) - тобто вони виявляються в момент виконання програми.
2. до виконання програми (виключення компіляції/ синтаксичні помилки) - програма навіть не запуститься (IndentationError)
